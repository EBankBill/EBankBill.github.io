define("app/marketingPlatform/worksInfo", ["gallery/zepto/1.1.3/zepto", "mobile/utils/simple/simpleTips", "./_imgResize", "mobile/utils/simple/simpleValidate"],
function(a) {
    ...
    b(function() {
        function a(a, c) {
            for (var e, f = 0; e = a[f]; f++) if (e.type.match("image.*")) {
                ...
                i.onload = function(a) {
                    return function(e) {
                        ...
                        i = null;
                        if ("works" === c) {
                            var l = b(g).insertBefore(b("#imgLastLi"));
                            f = b("img", l),
                            f.attr("src", e.target.result);
                            var m = new d(f.get(0), e.target.result, 194, 194);
                            m.init();
                            var i = null;
                            e.total > h ? lrz(a, {
                                width: 1024
                            ...
                            function(a) {
                                ...
                                n(),
                                j(i, l)
                            }) : (i = e.target.result, n(), j(i, l))
                        } else {
                            f = b("#headImg"),
                            f.attr("src", e.target.result).show().closest("li").removeClass("t_add1").addClass("t_pLoad");
                            var m = new d(f.get(0), e.target.result, 88, 88);
                            m.init();
                            var i = null;
                            e.total > h ? lrz(a, {
                                width: 1024
        ...
        function k(a, c) {
            b.post(pageConfig.uploadUrl, {
                ...
                vote_id: pageConfig.vote_id,
                imgData: a
            },
            function(a) {
                var e = JSON.parse(a);
                if (e.code > 0) {
                    c.attr("src", e.data).closest("li").removeClass("t_pLoad").addClass("t_pEdit");
                    var f = new d(c.get(0), e.data, 88, 88);
                    f.init(),
                    b("[name='head_img']").val(e.data)
                } else alert("头像上传失败")
            })
        }
        function l(d) {
            var e = d.target.files,
            f = b(".uploadImg").length;
            return e.length + f > i ? void c("最多只能上传1张") : (a(e, "works"), void(d.target.value = ""))
        }
        function m(b) {
        ...
        function n() {
            b(".uploadImg").length >= i ? b("#imgLastLi").hide() : b("#imgLastLi").show()
        }
        function o(a) {
            a.remove(),
            n()
        ...
        function p(a) {
            a.removeClass("t_pEdit").addClass("t_add1"),
            b("img", a).attr("src", "").hide(),
            b("[name='head_img']").val("")
        } (/iphone/i.test(navigator.userAgent) || /iPad/i.test(navigator.userAgent)) && setInterval(function() {
            var a = document.activeElement;
            "text" === a.type || "textarea" === a.type ? b("#editBtn").parent().parent().css("position", "static") : b("#editBtn").parent().parent().css("position", "fixed")
        },
        500),
        b(".uploadImg").each(function() {
            var a = b(this),
            c = a.attr("src"),
            e = new d(a.get(0), c, 194, 194);
            e.init(),
            a.css("visibility", "visible")
        });
        var q = b("#headImg");
        if (q.attr("src")) {
            var r = new d(q.get(0), q.attr("src"), 88, 88);
            r.init(),
        ...
        function() {
            ...
            if (a.hasClass("edit")) {
                var d = b("#form"),
                g = b("#imgViewDelTmp").html(),
                h = b("#imgViewEditTmp").html(),
                j = b(".imgLi"),
                k = b("#uploadImgBtn");
                a.text("保存").removeClass("edit").addClass("save"),
                b("input,textarea", d).prop("disabled", !1),
                j.append(g),
                j.last().after(h),
                n(),
                k.closest("li").addClass("t_pEdit"),
                k.on("click",
                function() {
                    var a = b(this).closest("li");
                    a.hasClass("t_add1") ? f.trigger("click") : a.hasClass("t_pEdit") && p(a)
                }),
                ...
                if (b("img.uploadImg").each(function() {
                    q.push(b(this).attr("src"))
                }), q.length <= 0) return void c("请上传作品");
                var r = b(".t_loading").length;
                if (r > 0) return void c("图片上传中，请稍等");
                var s = b(".t_pLoad").length;
                if (s > 0) return void c("头像上传中，请稍等");
                b("[name='work_img']").val(q.join("|")),
                a.text("保存中..."),
                pageConfig.needUserInfo ? b("#form").attr("action", pageConfig.jumpUrl).attr("method", "post").submit() : b.ajax({
